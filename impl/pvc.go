...
func GetPVC(c *gin.Context) {
	responseData := HandlePVC(common.Get, c)
	c.JSON(responseData.Code, responseData)
}

func ListPVC(c *gin.Context) {
	responseData := HandlePVC(common.List, c)
	c.JSON(responseData.Code, responseData)
}

func DeletePVC(c *gin.Context) {
	responseData := HandlePVC(common.Delete, c)
	c.JSON(responseData.Code, responseData)
}

func PatchPVC(c *gin.Context) {
	responseData := HandlePVC(common.Patch, c)
	c.JSON(responseData.Code, responseData)
}

func UpdatePVC(c *gin.Context) {
	responseData := HandlePVC(common.Update, c)
	c.JSON(responseData.Code, responseData)
}

func CreatePVC(c *gin.Context) {
	responseData := HandlePVC(common.Create, c)
	c.JSON(responseData.Code, responseData)
}
...
func HandlePVC(action common.ActionType, c *gin.Context) (responseData *common.ResponseData) {
	...
	r := resource.PVCResource{Params: commonParams}
	// 调用结构体方法
	switch action {
	case common.Get:
		response, err := r.Get()
