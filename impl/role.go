...
func GetRole(c *gin.Context) {
	responseData := HandleRole(common.Get, c)
	c.JSON(responseData.Code, responseData)
}

func ListRole(c *gin.Context) {
	responseData := HandleRole(common.List, c)
	c.JSON(responseData.Code, responseData)
}

func DeleteRole(c *gin.Context) {
	responseData := HandleRole(common.Delete, c)
	c.JSON(responseData.Code, responseData)
}

func PatchRole(c *gin.Context) {
	responseData := HandleRole(common.Patch, c)
	c.JSON(responseData.Code, responseData)
}

func UpdateRole(c *gin.Context) {
	responseData := HandleRole(common.Update, c)
	c.JSON(responseData.Code, responseData)
}

func CreateRole(c *gin.Context) {
	responseData := HandleRole(common.Create, c)
	c.JSON(responseData.Code, responseData)
}
...
func HandleRole(action common.ActionType, c *gin.Context) (responseData *common.ResponseData) {
	...
	r := resource.RoleResource{Params: commonParams}
	// 调用结构体方法
	switch action {
	case common.Get:
		response, err := r.Get()
