...
func GetClusterRoleBinding(c *gin.Context) {
	responseData := HandleClusterRoleBinding(common.Get, c)
	c.JSON(responseData.Code, responseData)
}

func ListClusterRoleBinding(c *gin.Context) {
	responseData := HandleClusterRoleBinding(common.List, c)
	c.JSON(responseData.Code, responseData)
}

func DeleteClusterRoleBinding(c *gin.Context) {
	responseData := HandleClusterRoleBinding(common.Delete, c)
	c.JSON(responseData.Code, responseData)
}

func PatchClusterRoleBinding(c *gin.Context) {
	responseData := HandleClusterRoleBinding(common.Patch, c)
	c.JSON(responseData.Code, responseData)
}

func UpdateClusterRoleBinding(c *gin.Context) {
	responseData := HandleClusterRoleBinding(common.Update, c)
	c.JSON(responseData.Code, responseData)
}

func CreateClusterRoleBinding(c *gin.Context) {
	responseData := HandleClusterRoleBinding(common.Create, c)
	c.JSON(responseData.Code, responseData)
}
...
func HandleClusterRoleBinding(action common.ActionType, c *gin.Context) (responseData *common.ResponseData) {
	...
	r := resource.ClusterRoleBindingResource{Params: commonParams}
	// 调用结构体方法
	switch action {
	case common.Get:
		response, err := r.Get()
