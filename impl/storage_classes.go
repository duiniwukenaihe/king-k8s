...
func GetStorageClasses(c *gin.Context) {
	responseData := HandleStorageClasses(common.Get, c)
	c.JSON(responseData.Code, responseData)
}

func ListStorageClasses(c *gin.Context) {
	responseData := HandleStorageClasses(common.List, c)
	c.JSON(responseData.Code, responseData)
}

func DeleteStorageClasses(c *gin.Context) {
	responseData := HandleStorageClasses(common.Delete, c)
	c.JSON(responseData.Code, responseData)
}

func PatchStorageClasses(c *gin.Context) {
	responseData := HandleStorageClasses(common.Patch, c)
	c.JSON(responseData.Code, responseData)
}

func UpdateStorageClasses(c *gin.Context) {
	responseData := HandleStorageClasses(common.Update, c)
	c.JSON(responseData.Code, responseData)
}

func CreateStorageClasses(c *gin.Context) {
	responseData := HandleStorageClasses(common.Create, c)
	c.JSON(responseData.Code, responseData)
}
...
func HandleStorageClasses(action common.ActionType, c *gin.Context) (responseData *common.ResponseData) {
	...
	r := resource.StorageClassesResource{Params: commonParams}
	// 调用结构体方法
	switch action {
	case common.Get:
		response, err := r.Get()
